...
class ResturantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create resturant" do
    assert_difference('Resturant.count') do
      post resturants_url, params: { resturant: { comment: @resturant.comment, title: @resturant.title } }
    end
  ...
  test "should update resturant" do
    patch resturant_url(@resturant), params: { resturant: { comment: @resturant.comment, title: @resturant.title } }
